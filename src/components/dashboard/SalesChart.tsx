...
export function SalesChart({ data, subtitle = "Rolling 12 months" }: SalesChartProps) {
  ...
  return (
    <Card className="rounded-2xl border-border/70 bg-gradient-to-br from-primary/10 via-background to-blue-50/40 shadow-sm w-full">
              ...
              <ResponsiveContainer width="100%" height="100%">
                {chartMode === "area" ? (
                  <AreaChart data={data} margin={{ top: 12, right: 22, left: 8, bottom: 4 }}>
                    <defs>
                      <linearGradient id="salesAreaGradientAdmin" x1="0" y1="0" x2="0" y2="1">
                  ...
                  content={({ active, payload, label }) => {
                    ...
                    return (
                      <div className="rounded-lg border bg-white/95 px-3 py-2 text-xs shadow-lg">
                        ...
                        <div className="mt-1 text-gray-700">Sales: {Number(payload[0].value || 0).toLocaleString()}</div>
                ...
                />
                    <Area
                      ...
                      stroke="#8979FF"
                      strokeWidth={3}
                      fill="url(#salesAreaGradientAdmin)"
                      fillOpacity={1}
