...
const defaultToastAnimationClassName =
...
>(({ className, variant, ...props }, ref) => {
  const isFloatingToast =
    typeof className === "string" && className.includes("floating-toast-transition");
  ...
  return (
    <ToastPrimitives.Root
      ...
      className={cn(
        ...
        !isFloatingToast && defaultToastAnimationClassName,
        className
      )}
      {...props}
    />
