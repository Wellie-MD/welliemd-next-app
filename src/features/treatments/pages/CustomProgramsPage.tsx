import { DeleteConfirmDialog, TreatmentPageHeader } from "../components/common";
import { PatientFlowTestModal } from "../components/builder/PatientFlowTestModal";
import { CatalogConnectionsDialog } from "../components/custom-programs/CatalogConnectionsDialog";
import { CustomProgramsContent } from "../components/custom-programs/CustomProgramsContent";
import { CustomProgramModal } from "../components/custom-programs/CustomProgramModal";
import { CustomProgramsHeaderActions, CustomProgramsToolbar } from "../components/custom-programs/CustomProgramsToolbar";
import { useCustomProgramsPage } from "../hooks/useCustomProgramsPage";
