export { default as ConsentsPage } from "./ConsentsPage";
export { default as ContentLibrariesPage } from "./ContentLibrariesPage";
...
export { default as TreatmentTypeDetailPage } from "./TreatmentTypeDetailPage";
export { default as TreatmentTypesPage } from "./TreatmentTypesPage";
