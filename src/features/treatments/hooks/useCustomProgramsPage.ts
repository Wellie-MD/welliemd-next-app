...
import { useCustomPrograms, useDeleteCustomProgram, useSaveCustomProgram } from "./useTreatmentLibraries";
import type { CustomProgramFormData } from "../components/custom-programs/CustomProgramModal";
