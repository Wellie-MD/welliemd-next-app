...
export const mockPrograms: Program[] = [
  ...
  // 9. Menopause Care (shares the "menopause" intake visit type with HRT)
  {
    id: "program-menopause-intake",
    name: "Menopause Intake",
    stage: "intake",
    treatmentTypeKey: "menopause",
    visitType: "menopause",
    questionCount: 9,
    checkoutQuestionCount: 1,
    status: "draft",
    updatedAt: new Date(Date.now() - 11 * 86400000).toISOString().split('T')[0],
    slug: "menopause-intake",
    authConfig: { email: true, phone: false, identity: false, account: true },
    checkoutQuestions: [],
    consentIds: [MOCK_IDS.CONSENT_TRUTHFULNESS, MOCK_IDS.CONSENT_TELEHEALTH, MOCK_IDS.CONSENT_PRIVACY, "consent-hrt"],
  },
