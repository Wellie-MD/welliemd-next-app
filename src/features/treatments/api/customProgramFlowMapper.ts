...
export type CustomProgramApiRecord = {
  ...
  assignment_runtime_state?: CustomProgram["assignmentRuntimeState"];
  runtime_ready_at?: string | null;
  source_assignment_checksum?: string | null;
  icon?: string;
  icon_bg?: string;
  icon_color?: string;
  tags?: string[];
...
export const mapCustomProgramFromApi = (
  ...
  return {
    ...
    assignmentRuntimeState: record.assignment_runtime_state ?? null,
    runtimeReadyAt: record.runtime_ready_at ?? null,
    sourceAssignmentChecksum: record.source_assignment_checksum ?? null,
