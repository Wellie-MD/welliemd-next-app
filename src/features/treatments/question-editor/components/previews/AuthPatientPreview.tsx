...
export function AuthPatientPreview() {
  return (
    <aside className="hidden h-full min-w-0 flex-col overflow-hidden border-l border-slate-800 bg-[#0f172a] xl:flex xl:w-[340px] 2xl:w-[380px]">
      ...
      <div className="flex-1 overflow-y-auto p-4 flex justify-center">
        <div className="mt-4 flex w-[min(320px,calc(100%-2rem))] flex-col overflow-hidden rounded-xl bg-white shadow-xl">
