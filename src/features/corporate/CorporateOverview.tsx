...
export default function CorporateOverview() {
  ...
  return <div className="space-y-6 p-4 sm:p-6"><div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center"><div><div className="mb-2 flex items-center gap-2"><Badge>Corporate pilot</Badge><span className="text-xs text-muted-foreground">Backend control-plane data</span></div><h1 className="text-2xl font-bold text-foreground">Corporate</h1><p className="mt-1 text-sm text-muted-foreground">Platform checkpoint for operator and employer pilot readiness.</p></div><Button asChild><Link to="/dashboard/corporate/operators">Review operators <ExternalLink className="ml-2 h-4 w-4" /></Link></Button></div>
