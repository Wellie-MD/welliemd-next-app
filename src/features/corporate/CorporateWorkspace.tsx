...
export default function CorporateWorkspace() {
  ...
  return (
    <div className="space-y-6 p-4 sm:p-6 lg:p-8">
      <div className="flex flex-col justify-between gap-3 md:flex-row md:items-start"><div><div className="mb-2 flex items-center gap-2"><Badge>Day 2 live</Badge><Badge variant="outline">Corporate Operator Admin</Badge></div><h1 className="text-2xl font-bold">Corporate Workspace</h1><p className="mt-1 text-sm text-muted-foreground">{context.operator.name} · authenticated employer portfolio</p></div><Badge variant="secondary" className="w-fit"><ShieldCheck className="mr-1 h-3.5 w-3.5" />Role and tenant scoped</Badge></div>
