...
function FlowBuilderContent() {
  ...
  const applyViewMode = useCallback(
    (mode: FlowViewMode) => {
      ...
      const shouldShowLabels = mode === "edit" || mode === "checkout";
    ...
    <div className="h-full w-full flex flex-col bg-gray-50">
      ...
      <div className="flex-1 flex relative overflow-hidden">
        ...
        <div className="flex-1 relative">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      ...
                      handleEditQuestion(selectedCheckoutQuestion.question)
                    }
                  ...
                  <Button
                    ...
                    className="h-8 text-xs"
                    onClick={() =>
                      handleOpenFullEditFromCheckout(selectedCheckoutQuestion?.nodeId)
                    }
            ...
            <div className="flex items-center gap-1">
              ...
              <ControlTooltip content="Checkout-only inspection mode with direct navigation and condition review.">
                <Button
                  ...
                  disabled={checkoutQuestionList.length === 0}
                >
                  Checkout
                </Button>
              </ControlTooltip>
                        ...
                        <div className="rounded-xl border border-dashed border-border bg-muted/20 p-4 space-y-3">
                          <div>
                            <div className="text-sm font-medium text-foreground">
                              No checkout-type questions found
                            </div>
                            ...
                            {filteredCheckoutQuestionList.map((item, idx) => {
                              ...
                              return (
                                <div key={item.nodeId} className="relative">
                                  ...
                                  />
                                  <div
                                    className={`absolute -left-1 top-8 h-[2px] w-4 ${
                                      ...
                                      <div className="flex items-start justify-between gap-2">
                                        ...
                                        <div className="flex items-center gap-1 shrink-0">
                                          {counts.conditionalIn > 0 && (
                                            <Badge
                                              variant="secondary"
                                              className="text-[10px] h-4 px-1.5 border border-blue-200 bg-blue-50 text-blue-800"
                                            >
                                          ...
                                          {counts.outgoing > 0 && (
                                            <Badge
                                              variant="secondary"
                                              className="text-[10px] h-4 px-1.5 border border-emerald-200 bg-emerald-50 text-emerald-800"
                                            >
                  ...
                  <CardHeader className="pb-2 space-y-1.5">
                    ...
                    <div className="flex items-center justify-between gap-3 rounded-lg border border-border bg-muted/20 px-3 py-2">
                      <div className="text-xs text-muted-foreground">
                        Show only conditional/disqualify paths
                      </div>
                      <Switch
                      ...
                      <div className="rounded-xl border border-dashed border-border bg-muted/20 p-4 space-y-3">
                        <div className="text-sm font-medium text-foreground">
                          {checkoutQuestionList.length === 0
                            ? "No checkout question selected"
                            : "Select a checkout question"}
                        </div>
                        <div className="text-xs text-muted-foreground">
                          {checkoutQuestionList.length === 0
                        ...
                        <div className="mb-3 rounded-2xl border border-border bg-gradient-to-br from-muted/25 to-background p-3">
                          <div className="flex items-center justify-between gap-2">
                            <div className="flex items-center gap-2 mb-1 flex-wrap">
                              <Badge variant="secondary" className="text-[10px] h-4 px-1.5">
                                Q{selectedCheckoutQuestion.question.order_index}
                              </Badge>
                              <Badge variant="secondary" className="text-[10px] h-4 px-1.5">
                                checkout
                              </Badge>
                          ...
                          <div className="mt-2 flex flex-wrap items-center gap-2">
                            <ControlTooltip content="Copy question reference (Q#)">
                              <Button
                                ...
                                onClick={() => handleCopyCheckoutReference("q", selectedCheckoutQuestion)}
                              >
                                Copy Q
                              </Button>
                            </ControlTooltip>
                            <ControlTooltip content="Copy internal question node ID">
                              <Button
                                ...
                                size="sm"
                                className="h-7 text-[11px]"
                                onClick={() => handleCopyCheckoutReference("id", selectedCheckoutQuestion)}
                              >
                                Copy ID
                              </Button>
                            </ControlTooltip>
                          ...
                          {filteredCheckoutConditionRows.length === 0 ? (
                            ...
                            <>
                              {(["incoming", "outgoing"] as const).map((sectionDirection) => {
                                const rows = filteredCheckoutConditionRows.filter(
                                  (row) => row.direction === sectionDirection
                                );
                                  ...
                                  <div key={sectionDirection} className="space-y-2">
                                    ...
                                    {rows.map((row) => (
                                      ...
                                      >
                                        ...
                                        <div
                                            className={`text-xs ${
                                              row.direction === "incoming" ? "text-blue-900" : "text-emerald-900"
                                            }`}
                                          >
                                          {row.direction === "incoming" ? "Source" : "Target"}:{" "}
                                          {row.direction === "incoming"
                                            ? row.sourceOrderIndex
                                              ? `Q${row.sourceOrderIndex} · `
                                              : ""
                                            : row.targetOrderIndex
                                              ? `Q${row.targetOrderIndex} · `
                                              : ""}
                                          ...
                                          <div className="mt-1 flex flex-wrap items-center gap-1.5 text-xs">
                                            ...
                                            {row.triggerValue && (
                                              <ControlTooltip content={row.triggerValue}>
                                                <span
                                                  className={`max-w-full cursor-help rounded border px-1.5 py-0.5 ${
                                                    row.edgeKind === "disqualify"
                                                      ? "border-rose-200 bg-rose-50 text-rose-700"
                                                      : "border-border bg-muted/30 text-muted-foreground"
                                                  }`}
                                                >
                                                  ...
                                                  {truncateWithEllipsis(
                                                    row.triggerValue,
                                                    CHECKOUT_CONDITION_VALUE_PREVIEW_MAX
                                                  )}
                                                </span>
                                              </ControlTooltip>
                                            )}
                                        ...
                                        <div className="mt-2 flex flex-wrap gap-2">
                                          {row.direction === "incoming" &&
                                            row.sourceNodeId !== "disqualify-node" && (
                                              <Button
                                                variant="ghost"
                                                size="sm"
                                                className="h-7 text-[11px]"
                                                onClick={() =>
                                                  handleOpenFullEditFromCheckout(row.sourceNodeId)
                                                }
                                              >
                                          ...
                                          {row.direction === "outgoing" &&
                                            row.targetNodeId !== "disqualify-node" && (
                                              <Button
                                                variant="ghost"
                                                size="sm"
                                                className="h-7 text-[11px]"
                                                onClick={() =>
                                                  handleOpenFullEditFromCheckout(row.targetNodeId)
                                                }
                                              >
          ...
          <div
            className={`absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-2 bg-white border rounded-lg shadow-lg px-3 py-2 z-40 ${
              viewMode === "checkout" ? "hidden" : ""
            }`}
          >
